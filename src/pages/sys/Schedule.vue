  ...
  <div class="schedule">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button @click="scheduleEdit('add')"
                   type="primary"
    ...
    <el-table v-loading="tableLoading"
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button @click="deleteSchedule(scope.row)"
                     type="text"
                     size="small">删除</el-button>
          <el-button @click="scheduleEdit('edit',scope.row)"
                     type="text"
    ...
    <div v-if="scheduleStatus">
      <AddSchedule v-model="scheduleStatus"
                   :currentRow="currentRow"
                   :operateType='operateType'
                   @postRequest="postRequest"></AddSchedule>
    </div>
  </div>
</template>
