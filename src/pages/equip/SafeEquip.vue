<template>
  <div class="sage-equip">
    <el-form :inline="true"
      ...
      <el-form-item>
        <el-button type="primary"
                   @click="getSateEquipList">查询</el-button>
        <el-button type="primary"
                   @click="onReset">重置</el-button>
        <el-button type="success"
                   @click="updateEqp('add')">新增</el-button>
      </el-form-item>
    </el-form>
    <el-table v-loading="tableLoading"
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="text"
                     size="small"
                     @click="updateEqp('edit', scope.row)">编辑</el-button>
          <el-button type="text"
                     size="small"
    ...
    <div v-if="updEqipDiaStatus">
      <UpdEquiqDialog v-model="updEqipDiaStatus"
                      :title="updEqipDiaTitle"
                      :equipData="equipData"
                      @getSateEquipList="getSateEquipList"></UpdEquiqDialog>
    </div>
  </div>
</template>
