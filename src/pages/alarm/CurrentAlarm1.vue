<template>
  <div class="current-alarm" @click="changeNewAlarm">
    <div id="audiobox"></div>
    <!-- <audio src="../../assets/audio/general.wav" autoplay>您的浏览器不支持 audio 标签。</audio>
...
export default {
  ...
  methods: {
    ...
    pushBellSrc(bellSrc) {
      ...
      if (bellSrc === 'red') {
        audio.src = require('../../assets/audio/red.wav')
      } else if (bellSrc === 'general') {
        audio.src = require('../../assets/audio/general.wav')
      }
